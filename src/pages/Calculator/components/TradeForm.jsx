  ...
  <div className='row'>
      ...
      <div className="form-group col-lg-6 col-12 mb-3">
          ...
          <div className="input-group input-group-sm">
              ...
              <input type="text" className="form-control" placeholder="Sample here..."/>
          </div>
      </div>
      <div className="form-group col-lg-6 col-12 mb-3">
      ...
      <div className='col-12'>
        <button className='btn btn-primary d-block m-auto'><i className='bi bi-box-arrow-left'></i> Log Trade </button>
      </div>
  </div>
  )
}
